...
export async function before(m, { conn, participants }) {
  ...
  switch (m.messageStubType) {
    ...
    case 29:
      await sendEvent(`@${m.messageStubParameters[0].split('@')[0]} 𝘼𝐇𝐎𝐑𝐀 𝐄𝐒 𝐀𝐃𝐌𝐈𝐍 𝐄𝐍 𝐄𝐒𝐓𝐄 𝐆𝐑𝐔𝐏𝐎\n\n🫵 𝐀𝐂𝐂𝐈𝐎𝐍 𝐑𝐄𝐀𝐋𝐈𝐙𝐀𝐃𝐀 𝐏𝐎𝐑: ${usuario}`, [m.sender, m.messageStubParameters[0], ...groupAdmins])
      break

    case 30:
      await sendEvent(`@${m.messageStubParameters[0].split('@')[0]} 𝐃𝐄𝐉𝐀 𝐃𝐄 𝐒𝐄𝐑 𝐀𝐃𝐌𝐈𝐍 𝐄𝐍 𝐄𝐒𝐓𝐄 𝐆𝐑𝐔𝐏𝐎\n\n🫵 𝐀𝐂𝐂𝐈𝐎𝐍 𝐑𝐄𝐀𝐋𝐈𝐙𝐀𝐃𝐀 𝐏𝐎𝐑: ${usuario}`, [m.sender, m.messageStubParameters[0], ...groupAdmins])
      break
